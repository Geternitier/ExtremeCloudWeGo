...
func (p *UpdateReq) GetVersion() (v string) {
	return p.Version
}
func (p *UpdateReq) SetVersion(val string) {
	p.Version = val
}
...
type UpdateResp struct {
	Success bool   `thrift:"Success,1" frugal:"1,default,bool" json:"Success"`
	Idl     string `thrift:"idl,2" frugal:"2,default,string" json:"idl"`
}
...
func (p *UpdateResp) GetIdl() (v string) {
	return p.Idl
}
func (p *UpdateResp) SetSuccess(val bool) {
	p.Success = val
}
func (p *UpdateResp) SetIdl(val string) {
	p.Idl = val
}
...
func (p *UpdateResp) Field1DeepEqual(src bool) bool {
...
func (p *UpdateResp) Field2DeepEqual(src string) bool {

	if strings.Compare(p.Idl, src) != 0 {
		return false
	}
	return true
}
...
func (p *StudentServiceClient) Update(ctx context.Context, req *UpdateReq) (r *UpdateResp, err error) {
	var _args StudentServiceUpdateArgs
	_args.Req = req
	var _result StudentServiceUpdateResult
...
func NewStudentServiceProcessor(handler StudentService) *StudentServiceProcessor {
	...
	self.AddToProcessorMap("Update", &studentServiceProcessorUpdate{handler: handler})
	return self
}
...
type studentServiceProcessorUpdate struct {
	handler StudentService
}

func (p *studentServiceProcessorUpdate) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := StudentServiceUpdateArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := StudentServiceUpdateResult{}
...
type StudentServiceUpdateArgs struct {
	Req *UpdateReq `thrift:"req,1" frugal:"1,default,UpdateReq" json:"req"`
}

func NewStudentServiceUpdateArgs() *StudentServiceUpdateArgs {
	return &StudentServiceUpdateArgs{}
}

func (p *StudentServiceUpdateArgs) InitDefault() {
	*p = StudentServiceUpdateArgs{}
}

var StudentServiceUpdateArgs_Req_DEFAULT *UpdateReq

func (p *StudentServiceUpdateArgs) GetReq() (v *UpdateReq) {
	if !p.IsSetReq() {
		return StudentServiceUpdateArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *StudentServiceUpdateArgs) SetReq(val *UpdateReq) {
	p.Req = val
}

var fieldIDToName_StudentServiceUpdateArgs = map[int16]string{
	1: "req",
}

func (p *StudentServiceUpdateArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *StudentServiceUpdateArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_StudentServiceUpdateArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *StudentServiceUpdateArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewUpdateReq()
	if err := p.Req.Read(iprot); err != nil {
		return err
	}
...
func (p *StudentServiceUpdateArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *StudentServiceUpdateArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *StudentServiceUpdateArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("StudentServiceUpdateArgs(%+v)", *p)
}

func (p *StudentServiceUpdateArgs) DeepEqual(ano *StudentServiceUpdateArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *StudentServiceUpdateArgs) Field1DeepEqual(src *UpdateReq) bool {
...
type StudentServiceUpdateResult struct {
	Success *UpdateResp `thrift:"success,0,optional" frugal:"0,optional,UpdateResp" json:"success,omitempty"`
}

func NewStudentServiceUpdateResult() *StudentServiceUpdateResult {
	return &StudentServiceUpdateResult{}
}

func (p *StudentServiceUpdateResult) InitDefault() {
	*p = StudentServiceUpdateResult{}
}

var StudentServiceUpdateResult_Success_DEFAULT *UpdateResp

func (p *StudentServiceUpdateResult) GetSuccess() (v *UpdateResp) {
	if !p.IsSetSuccess() {
		return StudentServiceUpdateResult_Success_DEFAULT
	}
	return p.Success
}
func (p *StudentServiceUpdateResult) SetSuccess(x interface{}) {
	p.Success = x.(*UpdateResp)
}

var fieldIDToName_StudentServiceUpdateResult = map[int16]string{
	0: "success",
}

func (p *StudentServiceUpdateResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *StudentServiceUpdateResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_StudentServiceUpdateResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *StudentServiceUpdateResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *StudentServiceUpdateResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *StudentServiceUpdateResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *StudentServiceUpdateResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("StudentServiceUpdateResult(%+v)", *p)
}

func (p *StudentServiceUpdateResult) DeepEqual(ano *StudentServiceUpdateResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *StudentServiceUpdateResult) Field0DeepEqual(src *UpdateResp) bool {
